            ...
            <div class="col-xl-6 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">New Sub Categorie</h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{route('admin.save_Sub_Categorie')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="inputState" name="categorie_name" class="default-select form-control @error('categorie_name') is-invalid @enderror wide">
                                    ...
                                    <div class="mb-3 mt-3 row">
                                        <div class="col-sm-10">
                                            <button type="submit" class="btn btn-primary">Add Sub categorie</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
