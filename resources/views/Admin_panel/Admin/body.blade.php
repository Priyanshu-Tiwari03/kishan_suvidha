            ...
            <div class="row">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-header media border-0 pb-0">
                            <div class="media-body">
                                <h2 class="text-black">{{$total_food}} <span class="text-success fs-14">+4%</span></h2>
                ...
                <div class="col-xl-3 col-lg-3 col-sm-6">
                    <div class="card overflow-hidden">
                        <div class="card-header media border-0 pb-0">
                            <div class="media-body">
                                <h2 class="text-black">{{$total_user}} <span class="text-danger fs-14">-3%</span></h2>
                            ...
                            <div class="table-responsive ">
                                <table class="table order-request">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="me-3 img-fluid rounded-circle" width="75" src="{{asset('admin-assets/images/card/pic1.jpg')}}" alt="DexignZone">
                                                <div class="media-body">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="me-3 img-fluid rounded-circle" width="75" src="{{asset('admin-assets/images/card/pic2.jpg')}}" alt="DexignZone">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-2"><a href="ecom-product-detail.html" class="text-black">Mozarella Pizza With Random Topping</a></h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="me-3 img-fluid rounded-circle" width="75" src="{{asset('admin-assets/images/card/pic3.jp')}}g" alt="DexignZone">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-2"><a href="ecom-product-detail.html" class="text-black">Sweet Cheezy Pizza for Kids Meal (Small Size)</a></h5>
                                                    <p class="mb-0 text-primary">#0010235</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="me-3 img-fluid rounded-circle" width="75" src="{{asset('admin-assets/images/card/pic6.jp')}}g" alt="DexignZone">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-2"><a href="ecom-product-detail.html" class="text-black">Tuna soup spinach with himalaya salt</a></h5>
                                                    <p class="mb-0 text-primary">#0010235</p>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="me-3 img-fluid rounded-circle" width="75" src="{{asset('admin-assets/images/card/pic7.jp')}}g" alt="DexignZone">
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-2"><a href="ecom-product-detail.html" class="text-black">Mozarella Pizza With Random Topping</a></h5>
                                                    <p class="mb-0 text-primary">#0010299</p>
                                                </div>
                            ...
                            <div class="widget-media trending-menus">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-3">
                                                <img alt="image" width="90" src="{{asset('admin-assets/images/card/pic8.jp')}}g">
                                                <div class="number">#1</div>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-3"><a href="ecom-product-detail.html" class="text-black">Chicken curry special with cucumber</a></h5>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-3">
                                                <img alt="image" width="90" src="{{asset('admin-assets/images/card/pic4.jp')}}g">
                                                <div class="number">#2</div>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-3"><a href="ecom-product-detail.html" class="text-black">Watermelon juice with ice</a></h5>
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-3">
                                                <img alt="image" width="90" src="{{asset('admin-assets/images/card/pic9.jp')}}g">
                                                <div class="number">#3</div>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-3"><a href="ecom-product-detail.html" class="text-black">Italiano pizza with garlic</a></h5>
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-3">
                                                <img alt="image" width="90" src="{{asset('admin-assets/images/card/pic6.jp')}}g">
                                                <div class="number">#4</div>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-3"><a href="ecom-product-detail.html" class="text-black">Tuna soup spinach with himalaya salt</a></h5>
                                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-3">
                                                <img alt="image" width="90" src="{{asset('admin-assets/images/card/pic10.j')}}pg">
                                                <div class="number">#5</div>
                                            </div>
                                            <div class="media-body">
                                                <h5 class="mb-3"><a href="ecom-product-detail.html" class="text-black">Medium Spicy Spagethi Italiano</a></h5>
                                                <div class="d-flex justify-content-between align-items-center">
