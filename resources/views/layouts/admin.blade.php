            ...
            <div class="main-container container-fluid">
                <div class="main-header-left">
                    ...
                    <div class="hor-logo">
                        <a class="main-logo" href="">
                            <img src="{{asset('admin-assets_1/images/kisansplash.png')}}"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="kisanslash.png" height="40" class="header-brand-img desktop-logo-dark" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="main-header-center">
                    <div class="responsive-logo">
                        <a href="">
                            <img src="{{ asset('assets/logos/logo-dark - Copy (2).png') }}" class="mx-2 mobile-logo"
                                alt="logo"></a>
                        <a href=""><img src="{{ asset('assets/logos/favicon - Copy.png') }}s" height="40"
                    ...
                    <div class="dropdown main-profile-menu">
                        <a class="d-flex" href="javascript:void(0);">
                            <span class="main-img-user">
                                <img src="{{ asset('assets/logos/logo-dark - Copy - Copy.png') }}" alt="avatar">

                                {{-- <img alt="avatar" src="{{ asset('admin-assets/img/users/1.jpg') }}"> --}}-->
                            </span>
                        </a>
                        <div class="dropdown-menu">
            ...
            <div class="main-menu main-sidebar main-sidebar-sticky side-menu">
                <div class="main-sidebar-header main-container-1 active">
                    <div class="sidemenu-logo">
                        <a class="main-logo" href="">
                            <img src="{{ asset('assets/logos/logo-dark - Copy - Copy.png') }}"
                                class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{ asset('assets/logos/favicon - Copy.png') }}" class="header-brand-img icon-logo"
                                alt="logo">
                            <img src="{{ asset('assets/logos/logo-dark - Copy (2).png') }}"
                                class="header-brand-img desktop-logo theme-logo" alt="logo">
                            <img src="{{ asset('assets/logos/favicon - Copy.png') }}"
